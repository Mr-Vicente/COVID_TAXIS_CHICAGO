...
CREATE UNLOGGED TABLE IF NOT EXISTS covid_chicago_taxis (
  trip_id text,
  taxi_id text,
...
FROM '/Users/FrederioVicente/Desktop/Mestrado/5ºano/MD/projeto/tables/fact_tables/covid_chicago_taxis.csv'
DELIMITER ','
CSV
HEADER;
...
CREATE TABLE IF NOT EXISTS covid_chicago_taxis (
  trip_id text,
  taxi_id text,
  trip_seconds int,
  trip_miles float,
...
COPY OFFSET 2 into covid_chicago_taxis(
  trip_id,
  taxi_id,
  trip_seconds,
  trip_miles,
